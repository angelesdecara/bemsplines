...
class BEM:
    ...
    def _bem_matrix_pp(self):
        ...
        time_ee = time.time() 
        print("time to calculate ee_matrix = ",time_ee - time_start)
        
        Gbh, _, _ = self._bem_ej_matrix(bsurf[0], hsurf - 1)
        time_gbh = time.time()
        print("time Gbh matrix = ", time_gbh - time_ee )
        Ghh, _, _ = self._bem_ej_matrix(hsurf - 1, hsurf - 1)
        time_ghh = time.time()
        print("time Ghh matrix =", time_ghh - time_gbh)
        ...
        print("time building Ps=",time_end_build - time_start_build)
